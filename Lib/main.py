...
class DemoMain(QMainWindow, Ui_MainWindow):
    ...
    def init(self):
        ...
        item = QtWidgets.QTableWidgetItem('1797')
        #bug
        ...
        item = QtWidgets.QTableWidgetItem('29.9')
        self.tableWidget_4.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem('29.9')
        self.tableWidget_4.setItem(1, 3, item)
        item = QtWidgets.QTableWidgetItem('162.2')
        self.tableWidget_4.setItem(1, 5, item)
        item = QtWidgets.QTableWidgetItem('107.4')
        self.tableWidget_4.setItem(1, 7, item)
        item = QtWidgets.QTableWidgetItem('11.9')
